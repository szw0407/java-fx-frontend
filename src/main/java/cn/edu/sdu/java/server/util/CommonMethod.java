...
public class CommonMethod {
    ...
    public static LocalDate getLocalDate(Map<String, Object> form, String practiceTime) {
        return LocalDate.parse(CommonMethod.getString(form, practiceTime), DateTimeFormatter.ofPattern("yyyy-MM-dd"));
    }
}
