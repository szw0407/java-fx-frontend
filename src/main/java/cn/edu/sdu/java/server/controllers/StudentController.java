...
/**
 * StudentController 主要是为学生管理数据管理提供的Web请求服务 处理http请求，返回响应
 */
...
public class StudentController {
    ...
    @PostMapping("/getStudentList")//表示这个方法处理 /getStudentList 的 POST 请求
    @PreAuthorize("hasRole('ADMIN')")//控制访问权限，只有admin才能调用这个接口
